    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#FFFFFF' }}>
      ...
      <section style={{ background: 'linear-gradient(135deg, #EFF6FF 0%, #F0F4FF 100%)', borderBottom: '1px solid #E5E7EB', padding: '4rem 2rem', textAlign: 'center' }}>
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
          <p style={{ color: '#E84C3D', fontWeight: 700, fontSize: '1rem', marginBottom: '1rem', letterSpacing: '0.05em' }}>FREE DOWNLOAD — UPDATED FEB 2026</p>
          ...
          <p style={{ fontSize: '1.25rem', color: '#6B7280', lineHeight: 1.6, marginBottom: '2rem' }}>
            Get our free YouTube Gear Guide Checklist + Budget Planner + 30-Day Action Plan.
          ...
          {status === 'success' ? (
            <div style={{ backgroundColor: '#F8F9FA', borderRadius: '1rem', padding: '2rem', border: '2px solid #22c55e' }}>
              ...
              <div style={{ display: 'flex', gap: '0.75rem', justifyContent: 'center', flexWrap: 'wrap' }}>
                <a href="/freebies/youtube-creator-gear-checklist.html" style={{ backgroundColor: '#E84C3D', color: '#FFFFFF', padding: '0.75rem 1.5rem', borderRadius: '0.5rem', fontWeight: 700, textDecoration: 'none' }}>📋 Gear Checklist</a>
                <a href="/freebies/gear-budget-planner.html" style={{ background: '#E84C3D', color: 'white', padding: '0.75rem 1.5rem', borderRadius: '0.5rem', fontWeight: 700, textDecoration: 'none' }}>💰 Budget Planner</a>
                <a href="/freebies/30-day-action-plan.html" style={{ background: '#E84C3D', color: 'white', padding: '0.75rem 1.5rem', borderRadius: '0.5rem', fontWeight: 700, textDecoration: 'none' }}>🚀 30-Day Plan</a>
              </div>
            </div>
          ) : (
            <form onSubmit={handleSubmit} style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap', justifyContent: 'center', maxWidth: '500px', margin: '0 auto' }}>
              ...
              <button type="submit" disabled={status === 'loading'}
                style={{ padding: '1rem 2rem', borderRadius: '0.5rem', border: 'none', backgroundColor: '#E84C3D', color: '#FFFFFF', fontWeight: 800, fontSize: '1rem', cursor: 'pointer', whiteSpace: 'nowrap', width: '100%' }}>
      ...
      <section style={{ padding: '4rem 2rem', maxWidth: '900px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1.5rem' }}>
          <div style={{ backgroundColor: '#F8F9FA', borderRadius: '1rem', padding: '1.5rem', textAlign: 'center' }}>
            ...
            <h3 style={{ color: '#E84C3D', marginBottom: '0.5rem' }}>Gear Checklist</h3>
          ...
          <div style={{ backgroundColor: '#F8F9FA', borderRadius: '1rem', padding: '1.5rem', textAlign: 'center' }}>
            <div style={{ fontSize: '2.5rem', marginBottom: '0.75rem' }}>💰</div>
            <h3 style={{ color: '#E84C3D', marginBottom: '0.5rem' }}>Budget Planner</h3>
          ...
          <div style={{ backgroundColor: '#F8F9FA', borderRadius: '1rem', padding: '1.5rem', textAlign: 'center' }}>
            <div style={{ fontSize: '2.5rem', marginBottom: '0.75rem' }}>🚀</div>
            <h3 style={{ color: '#E84C3D', marginBottom: '0.5rem' }}>30-Day Action Plan</h3>
      ...
      <section style={{ backgroundColor: '#F8F9FA', padding: '3rem 2rem', textAlign: 'center' }}>
        <div style={{ display: 'flex', gap: '2rem', justifyContent: 'center', flexWrap: 'wrap', maxWidth: '700px', margin: '0 auto' }}>
          <div><span style={{ fontSize: '2rem', fontWeight: 800, color: '#E84C3D' }}>68</span><br /><span style={{ color: '#6B7280', fontSize: '0.9rem' }}>Products Reviewed</span></div>
          <div><span style={{ fontSize: '2rem', fontWeight: 800, color: '#E84C3D' }}>25</span><br /><span style={{ color: '#6B7280', fontSize: '0.9rem' }}>Detailed Guides</span></div>
          <div><span style={{ fontSize: '2rem', fontWeight: 800, color: '#E84C3D' }}>40+</span><br /><span style={{ color: '#6B7280', fontSize: '0.9rem' }}>Reddit Threads Analyzed</span></div>
      ...
      <section style={{ padding: '4rem 2rem', maxWidth: '700px', margin: '0 auto' }}>
        ...
        {[
          ...
          <div key={i} style={{ backgroundColor: '#F8F9FA', borderRadius: '0.75rem', padding: '1.25rem', marginBottom: '1rem' }}>
            <h3 style={{ color: '#E84C3D', fontSize: '1rem', marginBottom: '0.5rem' }}>{faq.q}</h3>
      ...
      <section style={{ background: '#EFF6FF', padding: '3rem 2rem', textAlign: 'center' }}>
        ...
        <a href="#" onClick={(e) => { e.preventDefault(); window.scrollTo({ top: 0, behavior: 'smooth' }); }}
          style={{ display: 'inline-block', backgroundColor: '#E84C3D', color: '#FFFFFF', padding: '1rem 2rem', borderRadius: '0.5rem', fontWeight: 800, textDecoration: 'none', fontSize: '1.1rem' }}>
          Get Your Free Tools ↑
        </a>
      </section>
