          ...
          <table style={{
            ...
            <thead>
              <tr style={{ borderBottom: '2px solid #FF6B35' }}>
                <th style={{ textAlign: 'left', padding: '15px', color: '#FF6B35', fontWeight: 'bold' }}>Software</th>
                ...
                <th style={{ textAlign: 'left', padding: '15px', color: '#FF6B35', fontWeight: 'bold' }}>Platform</th>
              ...
              {software.map((soft, idx) => (
                <tr key={idx} style={{
                  ...
                  <td style={{ padding: '15px' }}>
                    <Link href={`/guides/${soft.slug}`} style={{ color: '#FF6B35', textDecoration: 'none', fontWeight: '600' }}>
                      {soft.name} →
                    </Link>
                  </td>
                  <td style={{ padding: '15px', color: '#FF6B35', fontWeight: 'bold' }}>{soft.price}</td>
                  <td style={{ padding: '15px' }}>
                    <span style={{ color: '#FFB81C' }}>★</span> {soft.rating}
                  </td>
                  <td style={{ padding: '15px', color: '#aaa' }}>Windows/Mac/Linux</td>
                  <td style={{ padding: '15px', color: '#aaa', fontSize: '13px' }}>{soft.bestFor}</td>
                </tr>
              ))}
            </tbody>
          </table>
          ...
          {software.map((soft, idx) => (
            <div key={idx} style={{
              ...
              <div style={{ padding: '20px' }}>
                ...
                <p style={{ color: '#FF6B35', fontWeight: 'bold', marginBottom: '15px' }}>{soft.price}</p>
