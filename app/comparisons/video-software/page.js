          ...
          <table style={{
            ...
            <thead>
              <tr style={{ borderBottom: '2px solid #E84C3D' }}>
                <th style={{ textAlign: 'left', padding: '15px', color: '#E84C3D', fontWeight: 'bold' }}>Software</th>
                ...
                <th style={{ textAlign: 'left', padding: '15px', color: '#E84C3D', fontWeight: 'bold' }}>Platform</th>
              ...
              {software.map((soft, idx) => (
                <tr key={idx} style={{
                  ...
                  <td style={{ padding: '15px' }}>
                    <Link href={`/guides/${soft.slug}`} style={{ color: '#E84C3D', textDecoration: 'none', fontWeight: '600' }}>
                      {soft.name} →
                    </Link>
                  </td>
                  <td style={{ padding: '15px', color: '#E84C3D', fontWeight: 'bold' }}>{soft.price}</td>
                  <td style={{ padding: '15px' }}>
          ...
          {software.map((soft, idx) => (
            <div key={idx} style={{
              ...
              <div style={{ padding: '20px' }}>
                ...
                <p style={{ color: '#E84C3D', fontWeight: 'bold', marginBottom: '15px' }}>{soft.price}</p>
